...
urlpatterns = [
    ...
    path('password-change/', log_view.PasswordChangeView.as_view(template_name='application/password-change.html', success_url='password-change-complete'), name='password-change'),  # View to change password
    path('password-change/password-change-complete/', log_view.PasswordChangeDoneView.as_view(template_name='application/password-change-complete.html'), name='password-change-complete'),  # Password change success page
